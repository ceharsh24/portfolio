        ...
        <Container>
          ...
          <Row className="container-education-body">
            ...
            <div className="university-year">
              <ul>
                <li><span><strong>Degree: </strong>Master's</span></li>
                <li><span><strong>Major: </strong>Computer Science</span></li>
                <li><span><strong>Location: </strong>Albany, NY</span></li>
              </ul>
            </div>
            </Col>
            <Col md={6}>
            ...
            <div className="university-year">
              <ul>
                <li><span><strong>Degree: </strong>Bachelor's</span></li>
                <li><span><strong>Major: </strong>Computer Engineering</span></li>
                <li><span><strong>Location: </strong>Gujarat, India</span></li>
              </ul>
            </div>
            </Col>
          </Row>
