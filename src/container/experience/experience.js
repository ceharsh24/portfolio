      ...
      <section className="container-experience" id="experience">
        <Container>
          ...
          <Row className="container-experience-body">
            ...
            <Col md={8}>
              {this.renderCompanyDetails('IBM', 'Software Developer', 'November 2019 - Current')}
          ...
          <Row className="container-experience-body">
            ...
            <Col md={8}>
              {this.renderCompanyDetails('SoluTech Inc.', 'Full-Stack Developer', 'August 2018 - October 2019')}
              <ul className="job-description">
                {this.renderJobDetails([
          ...
          <Row className="container-experience-body">
            ...
            <Col md={8}>
              {this.renderCompanyDetails('University at Albany', 'Research Assistant', 'August 2017 - August 2018')}
              <ul className="job-description">
                {this.renderJobDetails([
